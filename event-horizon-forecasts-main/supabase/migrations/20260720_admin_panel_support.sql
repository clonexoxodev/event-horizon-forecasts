...
-- ============================================================
-- 1. USERS TABLE — ensure all admin columns exist
-- ============================================================
...
-- ============================================================
-- 2. WALLETS TABLE — ensure all balance columns exist
-- ============================================================
...
-- ============================================================
-- 3. MARKETS TABLE — ensure all columns exist
-- ============================================================
-- Basic info
...
-- ============================================================
-- 4. POSITIONS TABLE — ensure all columns exist
-- ============================================================
...
-- ============================================================
-- 5. TRANSACTIONS TABLE — ensure all columns exist
-- ============================================================
...
-- ============================================================
-- 6. NOTIFICATIONS TABLE — ensure all columns exist
-- ============================================================
...
-- ============================================================
-- 7. MARKET_PRICE_HISTORY TABLE — ensure all columns exist
-- ============================================================
...
-- ============================================================
-- 8. DEPOSIT_REQUESTS TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 9. WITHDRAWAL_REQUESTS TABLE — create if missing
-- ============================================================
-- Drop and recreate if schema differs (migration not yet applied)
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name='withdrawal_requests') THEN
    -- Check if column 'amount' exists but 'amount_smallest_unit' doesn't
    IF EXISTS (
      ...
      -- Schema is old version; drop and recreate
...
-- ============================================================
-- 10. MARKET_COMMENTS TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 11. MARKET_TRADES TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 12. MARKET_ACTIVITY_EVENTS TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 13. MARKET_RESOLUTION_LOGS TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 14. SAVED_BANK_DETAILS TABLE — create if missing
-- ============================================================
...
-- ============================================================
-- 16. PROFILES TABLE — ensure extended columns exist
-- ============================================================
...
-- ============================================================
-- DONE — All 16 tables now exist with all required columns
-- ============================================================
