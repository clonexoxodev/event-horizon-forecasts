      ...
      <main className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:py-8">
        ...
        <section className="mt-6 rounded-2xl border border-[#E5E7EB] bg-white p-5">
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row">
            ...
            <Link to="/support" className="rounded-2xl border border-[#E5E7EB] bg-[#F3F4F6] px-5 py-3 text-center text-sm font-black text-[#101828] hover:border-[#4F46E5]/40">Support</Link>
          </div>
        </section>
      </main>
      <MobileNav />
