        ...
        <div className="mx-auto max-w-5xl">
          <div className="min-w-0">
            <section className="border-b border-[#E5E7EB] pb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-2 flex flex-wrap items-center gap-2">
                    ...
                    <span className={`rounded-full px-2.5 py-1 text-[11px] font-black ${marketIsActive ? (activation.isProtected ? "bg-[#EEF2FF] text-[#4F46E5]" : "bg-[#12B886]/10 text-[#047857]") : "bg-[#F3F4F6] text-[#667085]"}`}>
                      {marketIsActive ? (activation.isProtected ? "Refund Protected" : "Live") : "Closed"}
                    </span>
                  </div>
              ...
              {activation.isProtected && (
                <div className="mt-5 rounded-2xl border border-[#C7D2FE] bg-[#EEF2FF] p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="text-sm font-black text-[#101828]">Protected Market</div>
                    <span className="rounded-full bg-white px-3 py-1 text-[11px] font-black text-[#4F46E5]">Refund Protected</span>
                  </div>
                  ...
                  <p className="mt-3 text-sm font-bold leading-6 text-[#344054]">
                    You can predict now. If this market does not reach enough activity before closing, your stake is refunded.
                  </p>
                </div>
              )}
            </section>
          ...
          <div className="absolute bottom-0 left-0 right-0 max-h-[88vh] overflow-y-auto rounded-t-2xl border border-[#E5E7EB] bg-white p-5 pb-[calc(90px+env(safe-area-inset-bottom))] text-[#111827] shadow-[0_-24px_80px_rgba(17,24,39,0.18)] md:left-auto md:right-6 md:top-24 md:h-fit md:w-[380px] md:rounded-2xl md:pb-5" onClick={(event) => event.stopPropagation()}>
            ...
            {slipDataMissing ? (
              ...
              <>
                ...
                <Button onClick={confirmPrediction} disabled={submitting || numericAmount <= 0 || exceedsProtectedLimit} className={`mt-5 h-12 w-full rounded-xl text-base font-black ${sheetSide === "YES" ? "bg-[#12B886] text-[#06100d] hover:bg-[#2dd4a0]" : "bg-[#E85D5D] text-[#111827] hover:bg-[#f07575]"}`}>
