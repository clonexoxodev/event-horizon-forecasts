      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-10">
        <section className="rounded-3xl border border-[#E85D5D]/25 bg-[#E85D5D]/5 p-8">
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <h1 className="mt-2 text-3xl font-extrabold tracking-tight sm:text-4xl">Trade carefully. Risk is real.</h1>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="No payout is guaranteed early">
            <p>Any estimate before resolution is informational only and can change as the order book and matched positions change.</p>
