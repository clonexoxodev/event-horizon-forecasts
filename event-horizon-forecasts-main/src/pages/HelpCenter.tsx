        ...
        <section className="bg-white/60 py-16">
          <div className="container max-w-4xl">
            ...
            <div className="space-y-4">
              <Link to="/how-it-works" className="block p-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm hover:border-[#4F46E5]/30 hover:shadow-md transition-all">
              ...
              <Link to="/faq" className="block p-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm hover:border-[#4F46E5]/30 hover:shadow-md transition-all">
              ...
              <Link to="/risk-disclaimer" className="block p-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm hover:border-[#4F46E5]/30 hover:shadow-md transition-all">
