...
export const Header = () => {
  ...
  return (
    <>
      ...
      {/* ── Top header bar ── */}
      <header
        className="sticky top-0 z-40 border-b border-[#E5E7EB] bg-white/80 backdrop-blur-xl md:block"
        role="banner"
      >
        <div className="mx-auto flex max-w-[1320px] items-center gap-3 px-4 py-3 sm:px-6">
          ...
          <Link to="/" className="flex shrink-0 items-center gap-2.5" aria-label="FLIPPE home">
            ...
            <span className="text-lg font-extrabold tracking-[0.04em] text-[#111827]">
              FLIPPE
            </span>
          </Link>
          ...
          {user && (
            <Link
              ...
              className="hidden items-center gap-1.5 rounded-full border border-[#E5E7EB] bg-white px-3.5 py-1.5 text-sm font-bold text-[#111827] transition hover:border-[#4F46E5]/30 hover:shadow-sm md:flex"
            >
