-- SQLite Schema for Prediction Platform
...
CREATE TABLE IF NOT EXISTS positions (
  ...
  is_winner INTEGER, -- SQLite uses INTEGER for boolean (0/1)
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  is_read INTEGER NOT NULL DEFAULT 0, -- SQLite uses INTEGER for boolean (0/1)
  reference_id TEXT,
  reference_type TEXT,
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
